  ...
  <div>
    ...
    <div class="card" style="margin-bottom:14px;background:linear-gradient(135deg,#FAE8E6,#FAF7F5);border:1px solid #FECDD3;cursor:pointer;" onclick="setPage('ecommerce')">
      <div style="display:flex;align-items:center;gap:12px;">
        ...
        <div style="flex:1;">
          <div style="font-weight:700;font-size:14px;color:#9F1239;">Configurações do Site / E-commerce</div>
          <div style="font-size:11px;color:#9F1239;opacity:.7;margin-top:2px;">Clique para abrir o módulo E-commerce — Site (Avançado), Integrações, Aparência, Páginas, Pagamentos, Banners. Tudo do site fica lá.</div>
        </div>
        <span style="color:#9F1239;font-size:20px;">→</span>
      </div>
    </div>
    ` : ''}
