...
function renderApp(){
  ...
  const nav = [
    ...
    {k:'metas',l:'Metas e Bônus',i:'🎯',m:'reports',s:'Financeiro', adminOnly:true},
  ...
  const pageToMod = {
    ...
    ponto:'ponto', financeiro:'financial', relatorios:'reports', metas:'reports',
